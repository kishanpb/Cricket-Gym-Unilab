...
class EnvCfg:
    ...
    mujoco_compact_substeps: bool = False
    ...
    def validate(self):
        ...
        if self.mujoco_substep_engine not in ("rollout", "mjbatch"):
        ...
        if self.mujoco_compact_substeps and self.mujoco_substep_engine != "mjbatch":
